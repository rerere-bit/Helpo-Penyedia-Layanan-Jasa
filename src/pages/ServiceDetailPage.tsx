...
import { Star, MapPin, CheckCircle, Clock, MessageSquare, Loader2, ArrowLeft, AlertCircle } from 'lucide-react';
import { doc, getDoc } from 'firebase/firestore';
import { db } from '@/lib/firebase';
import { getServiceReviews } from '@/services/review.service';
import type { Service, Review } from '@/types';

// Import Komponen Modal Review (Kita pertahankan fitur ini dari HEAD)
// Pastikan file ini ada, jika belum ada nanti kita buat dummy-nya
    ...
    return (
      <DashboardLayout>
        <div className="flex flex-col items-center justify-center min-h-[60vh]">
          ...
          <p className="text-gray-500 mb-6">Layanan tidak ditemukan</p>
